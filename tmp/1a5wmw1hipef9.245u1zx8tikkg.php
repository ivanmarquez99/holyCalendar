          ...
          <div class="row g-0">
            <div class="col-lg-6">
              <div class="card-body p-md-5 mx-md-4">
                ...
                <form>
                  <p>Por favor, conéctate con tu cuenta</p>

                  <div class="mb-4">
                    <input type="email" id="form2Example11" class="form-control" placeholder="Email o usuario" />
                  </div>
                  ...
                  <div class="text-center d-flex flex-d flex-column pt-1 mb-5 pb-1">
                    <button class="btn btn-dark btn-block fa-lg mb-3" type="button">Conectar</button>
            ...
            <div class="col-lg-6 d-flex align-items-center bg-dark rounded-end">
              <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                <h4 class="mb-4">De cofrade para cofrades...</h4>
                <p class="small mb-0">Enterate en todo momento de los eventos de tu cofradía sin necesidad de tener que estar escribiendo por el grupo de tu junta molestando.
...
<?php echo $this->render('../templates/layout/'.$footer,NULL,get_defined_vars(),0); ?>